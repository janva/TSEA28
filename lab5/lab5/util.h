...
//volatile disallow compiler optimizations on these?
//derefence pointer to unsigned int at address add
//that is give me the content at address add
...
//file-static (defenition local to this translation unit)
