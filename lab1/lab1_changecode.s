...
;;
activatealarm
	move.b #1,d1 		;flagga för activt alarm
...
MAIN
	...
	jsr setuppasscode
	jsr setuperrormessage
	jsr activatealarm 	;start with activated alarm
	move.b #1,d1		;ha haaaa 
reset:
	jsr clearinput
getannotherkey:
	;; jsr waitforkey		;wait for user to push key
	jsr getkey		;get that key
	cmp.b #12,d4		;is read key 'C'
	beq main_dubblecheck
...
main_dubblecheck:
	...
	bra reset
main_newcode:
	move.l $4000,$4010		;har vi addet c
	bra activate
